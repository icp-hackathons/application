export const theme = {
  ...
  components: {
    ...
    Button: {
      ...
      colorBgTextHover: 'var(--primary-color, #77E5EF)',
    },
    Progress: {
    ...
    Modal: {
      ...
      colorIcon: 'var(--primary-color, #77E5EF)',
      boxShadow: '0px 4px 4px 0px rgba(255,255,255,.15) inset, 0px 0px 68px 0px rgba(255,255,255,.05) inset',
      headerBg: 'transparent',
    },
    Menu: {
      colorTextDisabled: '#4A6293',
      colorPrimary: '#09090B', // bg color of menu item
      darkItemBg: 'transparent',
      darkItemHoverBg: '#192438',
      darkItemHoverColor: '#77E5EF',
      darkItemColor: '#4A6293',
      darkItemSelectedColor: '#77E5EF',
    ...
    Breadcrumb: {
      iconFontSize: 16,
      itemColor: '#4A6293',
      lastItemColor: 'var(--primary-color, #77E5EF)',
    ...
    Empty: {
      colorText: 'var(--primary-color, #77E5EF)',
    },
    Alert: {
      colorText: 'white',
